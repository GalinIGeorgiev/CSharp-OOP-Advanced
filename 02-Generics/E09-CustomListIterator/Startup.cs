using E09_CustomListIterator.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace E09_CustomListIterator
{
    public class Startup
    {
        public static void Main()
        {
            ...
            while (true)
            {
                ...
                List<string> commandArgs = ParseInput(input);
                ...
                try
                {
                    switch (command)
                    {
                        case "Add":
                            ...
                            break;
                        case "Remove":
                            customList.Remove(int.Parse(commandArgs[0]));  // NB do not print removed element
                            break;
                        case "Contains":
